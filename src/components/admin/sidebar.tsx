...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/admin/profile/credentials", labelKey: "credentials", icon: GraduationCap, group: "content" },
                  ...
                  return (
                    <li key={item.href}>
                      <Link
                        ...
                        onClick={onNavigate}
                        className={cn(
                          "flex items-center rounded-r-lg border-l-4 px-4 py-2 text-xs font-semibold uppercase tracking-wider transition-colors",
